...
if [ ! -f /opt/kallithea/data/__isInitialized ]; then
    ...
    # create a file in persistent data folder so we know db has been initialized
    touch /opt/kallithea/data/__isInitialized
fi
